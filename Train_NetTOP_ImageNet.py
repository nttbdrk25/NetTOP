...
def main():
    ...
    if args.pretrained:
        ...
        model = build_NetTOP(1000, cifar=False,groups=1)            
    if args.gpu is not None:
    ...
    if args.evaluate:
        #pathcheckpoint = "./runsImageNet/%s/"%(args.arch + '_' + args.action) + "model_best.pth.tar"
        pathcheckpoint = "./checkpoints/ImageNet1k/model_best.pth.tar"
    ...
    directory = "runsImageNet/%s/"%(args.arch + '_' + args.action)
